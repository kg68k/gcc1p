...
#ifdef __human68k__
  unsigned sym_written_attr : 1;
  unsigned remote_attr : 1;
  unsigned common_attr : 1;
  unsigned relocate_attr : 1;
#endif
...
#ifdef __human68k__
#define TREE_SYM_WRITTEN(NODE) ((NODE)->common.sym_written_attr)
#define TREE_COMMON(NODE) ((NODE)->common.common_attr)
#define TREE_REMOTE(NODE) ((NODE)->common.remote_attr)
#define TREE_RELOCATE(NODE) ((NODE)->common.relocate_attr)
#define TREE_PCR_DATA(NODE) ((NODE)->common.lang_flag_3)
#define TREE_INTERRUPT(NODE) ((NODE)->common.lang_flag_3)
#define TREE_DOSCALL(NODE) ((NODE)->common.lang_flag_4)
#endif
