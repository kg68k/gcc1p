...
#ifdef __human68k__
#define REG_INIT_DBRA(RTX) ((RTX)->call)
#define MEM_MAY_IN_PCR(RTX) ((RTX)->call)
#define MEM_IN_REMOTE(RTX) ((RTX)->jump)
#define MEM_IN_PCR(RTX) ((RTX)->x68k_extention)
#endif
