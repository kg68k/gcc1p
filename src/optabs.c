...
#ifdef __human68k__
      MEM_IN_REMOTE (funexp) = 1;
      if (flag_all_short)
        {
          MEM_IN_PCR (funexp) = 1;
          MEM_MAY_IN_PCR (funexp) = 1;
        }
#endif
...

static optab
init_optab (code, tabs)
     enum rtx_code code;
     optab tabs;
{
  int i;
  optab op = tabs ? tabs : (optab) malloc (sizeof (struct optab));
  op->code = code;
...
/*  init_extends (); */
  ...
  add_optab = init_optab (PLUS, add_optab);
  sub_optab = init_optab (MINUS, sub_optab);
  smul_optab = init_optab (MULT, smul_optab);
  umul_optab = init_optab (UMULT, umul_optab);
  smul_widen_optab = init_optab (MULT, smul_widen_optab);
  umul_widen_optab = init_optab (UMULT, umul_widen_optab);
  sdiv_optab = init_optab (DIV, sdiv_optab);
  sdivmod_optab = init_optab (UNKNOWN, sdivmod_optab);
  udiv_optab = init_optab (UDIV, udiv_optab);
  udivmod_optab = init_optab (UNKNOWN, udivmod_optab);
  smod_optab = init_optab (MOD, smod_optab);
  umod_optab = init_optab (UMOD, umod_optab);
  flodiv_optab = init_optab (DIV, flodiv_optab);
  ftrunc_optab = init_optab (UNKNOWN, ftrunc_optab);
  and_optab = init_optab (AND, and_optab);
  andcb_optab = init_optab (UNKNOWN, andcb_optab);
  ior_optab = init_optab (IOR, ior_optab);
  xor_optab = init_optab (XOR, xor_optab);
  ashl_optab = init_optab (ASHIFT, ashl_optab);
  ashr_optab = init_optab (ASHIFTRT, ashr_optab);
  lshl_optab = init_optab (LSHIFT, lshl_optab);
  lshr_optab = init_optab (LSHIFTRT, lshr_optab);
  rotl_optab = init_optab (ROTATE, rotl_optab);
  rotr_optab = init_optab (ROTATERT, rotr_optab);
  mov_optab = init_optab (UNKNOWN, mov_optab);
  movstrict_optab = init_optab (UNKNOWN, movstrict_optab);
  cmp_optab = init_optab (UNKNOWN, cmp_optab);
  ucmp_optab = init_optab (UNKNOWN, ucmp_optab);
  tst_optab = init_optab (UNKNOWN, tst_optab);
  neg_optab = init_optab (NEG, neg_optab);
  abs_optab = init_optab (ABS, abs_optab);
  one_cmpl_optab = init_optab (NOT, one_cmpl_optab);
  ffs_optab = init_optab (FFS, ffs_optab);
